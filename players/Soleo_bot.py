...
"""Implement a randomness to sometimes play hands that aren't strong to beat 
conservative bot being dealer, folding too often is bad when a blind so fix that part too"""
